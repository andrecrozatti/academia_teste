<?php
    ...
    if (mysqli_num_rows($r) > 0) {
        ...
        <thead>
            <tr>
                <th width="10%"><strong>
                    <a href="usuario_menu.php?ordem=cod">Código</a></strong></th>
                <th width="25%"><strong>
        ...
        while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
            ...
            <td class="actions">
                ...
                <a href="usuario_exc.php?cod=' . $row['cod'] . '" class="btn btn-xs btn-danger">
                    Excluir</a>
            </td>
            </tr>';
        }
    ...
    if ($pagina > 1) {
        ...
        if($pagina_correta != 1)
        {
            $pag .= '<li class="page-item"><a class="page-link" href="usuario_menu.php?s=' . 
            ($inicio - $exiba) . 
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-5 pb-2 mb-3">
        ...
        <div class="col-md-6">
            <div class="input-group h2">
                <input type="text" id="busca" class="form-control" placeholder="Pesquisa de alunos por nome:">
