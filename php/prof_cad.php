<?php
    ...
    if (isset($_POST['enviou'])) {
        ...
        if (empty($erros)) {
            $q = "INSERT INTO professor 
                    (nome, cpf, endereco, numero, data_nasc, tel)
                VALUES
                    ('$n', '$cpf', '$end', '$num', '$dat', '$t')";
...
<main role="main" class="col-md-9 m-sm-auto  col-lg-10 px-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <form method="post" action="prof_cad.php">
    ...
    <div class="row">
        <div class="form-group col-md-8">
        <label >Email</label>
            <input type="email" name="email" placeholder="Digite o Email" value="<?php if (isset($_POST['email'])) echo $_POST['email']; ?>" class="form-control" >
        </div>
